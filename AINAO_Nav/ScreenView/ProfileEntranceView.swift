...
struct ProfileEntranceView: View {
    ...
    var body: some View {
        ...
        if (userProfile.userAccount.isSignedIn == true) {
            ProfileScreenView(userProfile: $userProfile, isEditingProfile: $isEditingProfile)
        } else if (userProfile.userAccount.isInitialized == true) {
            LoginNextGenView(userProfile: $userProfile, isEditingProfile: $isEditingProfile)
        } else {
            RegistrationNextGenView(userProfile: $userProfile, isEditingProfile: $isEditingProfile)
        }
//
//
//        NavigationView {
...
struct NonInitialized_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let userAccount = UserAccount(isInitialized: false, isSignedIn: false)
        
        ProfileEntranceView(userProfile:  .constant(userProfile), isEditingProfile :  .constant(true))
...
struct NonSignedIn_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let userAccount = UserAccount(isInitialized: true, isSignedIn: false) // Set signedIn to true
